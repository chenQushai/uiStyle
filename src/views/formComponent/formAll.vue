    ...
    <div class="padding-10">
        <div class="container">
            <div class="content">
                ...
                <p ref="btn" class="module-introduced">按钮控件,更多详见<a
                ...
                <p ref="radioCom" class="module-introduced">radio单选框组件，更多详见 <a
                    href="https://element.eleme.cn/#/zh-CN/component/radio">element-ui单选组件</a></p>
